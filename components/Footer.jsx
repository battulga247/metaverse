        ...
        flex flex-col gap-8`}>
          ...
          <div className="flex items-col ">
            <div className="mb-[50px] h-[2px] bg-white opacity-10 w-full">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4 p-5 pt-10">
                <h4 className="font-extrabold text-[24px] text-white">Metaversus</h4>
                <p className="font-normal text-[14px] text-white opacity-50">
                  Copyright &copy 2021-2022 Metaversus. All right reserved.
                </p>
